...
export const Sidebar = ({ className, onClose }: SidebarProps) => {
  ...
  return (
    <Fragment>
      <div className={classNames('flex-1 overflow-y-auto pt-5 pb-4', className)}>
        <div className="flex flex-shrink-0 items-center px-4 text-white">Sbanken → YNAB</div>
      ...
      >
        <div className="flex items-center">
          ...
          <div className="ml-3 text-sm font-medium ">Innstillinger</div>
        </div>
      </Link>
    </Fragment>
  );
