  ...
  return (
    <button
      className={classNames(
        'inline-flex justify-center items-center border font-medium focus:outline-none shadow-sm focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 disabled:bg-gray-300 disabled:cursor-not-allowed disabled:text-gray-500',
        className,
        {
